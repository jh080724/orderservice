...
public class CommonExceptionHandler {
    ...
    // Controller 단에서 발생하는 모든 예외를 일괄처리하는 클래스

    // 엔터티를 찾지 못햇을때 예외가 발생하고, 이 메서드가 호출된다.
    ...
    // @Valid(자카르타)를 통한 입력값 검증에서 에러 발생시 일괄 처리
    // @Validated(스프링)를 사용했다면 ConstraintViolationException 으로 처리 (Spring 제공 아노테이션)
